...
$db = mysqli_connect("localhost", "trieubao_admin", "quocbao123@"); //change parameters to what you use
if (!$db) {
...
if (!mysqli_select_db($db, "trieubao_cydia")) { //change myrepodb to your database name
